...
export const events: TimelineEvent[] = [
  ...
  },
  {
    ...
    description:
      "The Church of Christ (later renamed The Church of Jesus Christ of Latter-day Saints) was legally organized in New York, fulfilling the revelation recorded in D&C 20.",
  ...
  },
  {
    ...
    description:
      "Joseph and Hyrum Smith were moved from Liberty Jail to Daviess County Jail for a grand jury hearing.",
  ...
  },
  {
    ...
    description:
      "Members gathered at the Nauvoo temple site as all four cornerstones were laid, each carried into place by a quorum presidency. Joseph Smith dedicated the cornerstones.",
  ...
  },
  {
    ...
    description:
      "Brigham Young directed the cornerstone-laying at the Salt Lake Temple site (which he had marked back in July 1847).",
  ...
  },
  {
    ...
    description:
      "Wilford Woodruff set the granite capstone atop the Salt Lake Temple’s main spire. The angel Moroni statue was installed. A time capsule sealed in the capstone wasn’t opened again for 128 years.",
    category: "Salt Lake Temple",
    sources: [WIKIPEDIA, UNIVERSE],
  },
  {
  ...
  },
  {
    ...
    description:
      "About 100,000 people gathered in Salt Lake City for the Church’s 100th-anniversary general conference, with a First Presidency address broadcast by radio.",
    category: "Church Founding",
  ...
  },
  {
    ...
    description:
      "Gordon B. Hinckley dedicated the Palmyra Temple on the Church’s 170th anniversary. It sits on the former Smith farm, near the Sacred Grove.",
